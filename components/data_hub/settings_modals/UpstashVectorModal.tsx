...
export const UpstashVectorModal = ({ service, onClose, onSaveSuccess }: ModalProps) => {
    const {
        config,
        handleConfigChange,
        isSaving,
                    ...
                    <div>
                     ...
                     <div>
                        ...
                        <div className="relative mt-1">
                            <input type={isTokenVisible ? 'text' : 'password'} value={config.token || ''} onChange={e => handleConfigChange('token', e.target.value)} placeholder="Your Upstash token" className="w-full p-2 pr-10 bg-gray-700 rounded-lg text-sm" />
