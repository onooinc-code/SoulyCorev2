        ...
        >
            ...
            >
                ...
                <main className="p-6 space-y-4">
                    <p className="text-sm text-gray-400">Configure the connection to your Vercel Postgres database. These values are typically found in your Vercel project's environment variables.</p>
                    <div>
                        <label className="text-xs text-gray-400">POSTGRES_URL_NONPRISMA</label>
                        <input type="password" placeholder="postgres://..." className="w-full p-2 mt-1 bg-gray-700 rounded-lg text-sm" />
                    </div>
                </main>
                <footer className="flex justify-end gap-2 p-4 border-t border-gray-700">
                    ...
                    <button className="px-4 py-2 bg-blue-600 rounded-md text-sm hover:bg-blue-500">Save & Test Connection</button>
                </footer>
            </motion.div>
        </motion.div>
    );
