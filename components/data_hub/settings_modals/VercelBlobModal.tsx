        ...
        >
            ...
            >
                ...
                <main className="p-6 space-y-4">
                    <p className="text-sm text-gray-400">Configure Vercel Blob storage settings.</p>
                    <div>
                        <label className="text-xs text-gray-400">BLOB_READ_WRITE_TOKEN</label>
                        <input type="password" placeholder="vercel_blob_rw_..." className="w-full p-2 mt-1 bg-gray-700 rounded-lg text-sm" />
                    </div>
                </main>
