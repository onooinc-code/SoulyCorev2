        ...
        >
            ...
            >
                ...
                <main className="p-6 space-y-4">
                    <p className="text-sm text-gray-400">Configure Pinecone connection settings.</p>
                    <div>
                        <label className="text-xs text-gray-400">PINECONE_API_KEY</label>
                        <input type="password" placeholder="Your Pinecone API Key" className="w-full p-2 mt-1 bg-gray-700 rounded-lg text-sm" />
                    </div>
                </main>
