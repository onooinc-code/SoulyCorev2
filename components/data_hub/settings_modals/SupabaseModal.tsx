        ...
        >
            ...
            >
                ...
                <main className="p-6 space-y-4">
                    <p className="text-sm text-gray-400">Configure Supabase project connection settings.</p>
                    <div>
                        <label className="text-xs text-gray-400">Project URL</label>
                        <input type="text" placeholder="https://your-project.supabase.co" className="w-full p-2 mt-1 bg-gray-700 rounded-lg text-sm" />
                    </div>
                    <div>
                        <label className="text-xs text-gray-400">Anon Public Key</label>
