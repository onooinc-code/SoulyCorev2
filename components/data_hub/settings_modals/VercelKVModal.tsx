        ...
        >
            ...
            >
                ...
                <main className="p-6 space-y-4">
                    <p className="text-sm text-gray-400">Configure Vercel KV connection settings.</p>
                    <div>
                        <label className="text-xs text-gray-400">KV_URL</label>
                        <input type="text" placeholder="https://..." className="w-full p-2 mt-1 bg-gray-700 rounded-lg text-sm" />
                    </div>
                     <div>
                        <label className="text-xs text-gray-400">KV_REST_API_TOKEN</label>
                        <input type="password" placeholder="Your KV token" className="w-full p-2 mt-1 bg-gray-700 rounded-lg text-sm" />
                    </div>
                </main>
