...
import { PlusIcon, SparklesIcon, TrashIcon, SearchIcon, XIcon, PinIcon, PinFilledIcon, RefreshIcon, ChatBubbleLeftRightIcon } from '@/components/Icons';
        ...
        <div className="flex flex-col h-full bg-gray-900 border-r border-white/5 flex-shrink-0 w-full overflow-hidden">
            ...
            <div className="p-4 flex flex-col gap-3 border-b border-white/5">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        <button onClick={() => setConversationPanelOpen(false)} className="p-2 text-gray-400 hover:bg-gray-800 rounded-lg lg:hidden">
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="w-full bg-gray-800 border border-white/5 rounded-lg pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500 transition-all text-right text-gray-200 placeholder-gray-500"
                        dir="rtl"
                    />
                </div>
            </div>
                            ...
                            <div key={convo.id} className="group relative">
                                ...
                                >
                                    <div className="flex justify-between items-start mb-1">
                                        ...
                                        <h3 className={`text-sm font-medium truncate w-full pr-1 ${isActive ? 'text-indigo-100' : 'text-gray-300'}`}>
                                            {convo.title || 'محادثة جديدة'}
                                        </h3>
                                    </div>
                                    <span className="text-[10px] text-gray-500 block">
                                        {new Date(convo.lastUpdatedAt).toLocaleDateString('ar-EG')}
                                    </span>
                                </button>
                                ...
                                <div className="absolute left-2 top-1/2 -translate-y-1/2 hidden group-hover:flex items-center gap-1 bg-gray-900 shadow-md rounded-md p-0.5 border border-gray-700">
                                    <button 
                                        onClick={(e) => { e.stopPropagation(); generateConversationTitle(convo.id); }} 
                                        className="p-1.5 hover:bg-indigo-900/50 text-gray-400 hover:text-indigo-400 rounded transition-colors"
                                        title="توليد عنوان"
                                    >
                                    ...
                                    <button 
                                        ...
                                        className="p-1.5 hover:bg-red-900/50 text-gray-400 hover:text-red-400 rounded transition-colors"
                                        title="حذف"
                                    >
            ...
            <div className="p-4 border-t border-white/5 space-y-2 bg-gray-900 z-10">
                <button
                    ...
                    className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-all shadow-lg shadow-indigo-500/20 active:scale-95"
                >
