...
type ActiveView = 'chat' | 'dashboard' | 'search' | 'agent_center' | 'brain_center' | 'memory_center' | 'contacts_hub' | 'prompts_hub' | 'tools_hub' | 'projects_hub' | 'data_hub' | 'dev_center' | 'comm_hub' | 'experiences_hub' | 'tasks_hub' | 'memory_extraction_hub' | 'contextual_analyzer';
